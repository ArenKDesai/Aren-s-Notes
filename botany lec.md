...
The point on the stem where leaves attach is the **node**, which connects to the **petiole** that works as a connection between the node and the **blade** of the leaf. 