...
### Sexual Reproduction
Producing offspring through **meiosis** and fertilization. These are done with **diploids** cells, cells that process two complete sets of chromosomes (one from mom/dad). These chromosomes are **homol