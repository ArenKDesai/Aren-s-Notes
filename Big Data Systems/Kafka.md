...
There's also a setting called min.insync.replicas where if there are less than the minimum insync followers running, the leader refuses to store messages 