...
RDDs run on the grandularity of *tasks*, which run on a single CPU core and operate on a single *partition*, or subsect of the data, which is loaded entirely into mem
