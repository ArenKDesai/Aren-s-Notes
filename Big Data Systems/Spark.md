...
### Broadcast Hash Join
One of the tables is smaller than the other. This table can fit in memory, so it is broadcasted to all executors in the cluster, and a standard hash join is performed. This is the two main steps: 
