...
### Committing Messages
Committed messages are messages that have been successfully written to a minimum number of in-sync replicas, and are considered safe even if the leader goes down. Uncommitted messages have been written to the leader but not to the minimum number of in-s
