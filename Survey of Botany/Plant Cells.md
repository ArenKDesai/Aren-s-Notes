...
When DNA replicates, we need to replicate every chromosome. Helicase (all enzymes end in "ase") exists to unzip the DNA. Then, primase starts the new strand, and DNA polymerase adds the rest of the bases. Ligase glues the two separate strands back together. 
