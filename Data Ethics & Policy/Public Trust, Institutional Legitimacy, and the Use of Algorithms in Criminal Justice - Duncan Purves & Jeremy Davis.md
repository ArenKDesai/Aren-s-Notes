...
- The authors examine an argument by Karen Jones on the "three-place" account of trustworthiness and whether it applies to the trust between an institution and a user, rather than two people (and a domain of int)
### Quotes
