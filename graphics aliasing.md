...
## Anti-Aliasing
To avoid Moray patterns, we can filter out problems before we sample a continuous object to a discrete representation. We can do this by removing sharp edges in the sampling and thicken them out to cover more deterministic pixels. 