...
The **Sample Point** model works better since each sample is a specific location without area. This means there's space in-between pixels, which typically need to be associated with pixels with an alg