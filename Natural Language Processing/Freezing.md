...
Prior research also shows that the earlier layers of a network extract universal features, while later layers perform task-specific modelling (2.2). This means that if a de
