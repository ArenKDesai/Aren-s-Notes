...
Through case studies, the researchers propose that, when fine-tuning for specific tasks, the first 75% of layers can be frozen and last 25% of layers retrained to maintain 90% of the original quality ()
