...
Grid-based document representations can allow BERT to encode the textual *and* layout information as a 2D feature map to improve model performance. This is commonly called a BERTgrid model, one 
