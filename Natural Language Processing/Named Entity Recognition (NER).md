...
ViBERTgrid aims to solve this by constructing the BERTgrid and concatenating it with a CNN to construct a new multi-modal backbone network (3.1.2). The CNN and BERTgrid models are trained jointly. 