...
**Key Information Extraction (KIE)** is a pivotal task to extract values of pre-defined key fields from documents (1). Most models treat KIE as a token classification problem and solve it with deep learning models with either a **sequence-based**, **graph-based**, or **