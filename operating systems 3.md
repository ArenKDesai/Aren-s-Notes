...
Steps 8 and 9 are to read and write to the bar inode. Finally, step 10 is to write to the foo inode. This is done last for error protection; if there was a crash before step 10, we don't want the f
