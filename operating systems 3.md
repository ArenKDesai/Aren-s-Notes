...
The index block itself is a bit of a bottleneck, but we can alleviate some of those inefficiencies through hierarchical indexing. The inode is now a tree-like structure 