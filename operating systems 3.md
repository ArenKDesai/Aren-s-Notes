...
Bu how does the program know where those bit maps are? We create one more block: the **superblock**. It contains the ibit location, dbit location, inode region, data region, and "magic number" ()