...
Keep the linked list in a separate table. The table includes block indices and the next block indices to that block. We can read this whole table and cache it for quick access. 