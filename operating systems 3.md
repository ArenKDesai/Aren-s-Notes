...
The index block itself is a bit of a bottleneck, but we can alleviate some of those inefficiencies through hierarchical indexing. The inodes in the hierarchy now has a pointer to the data blocks and indirect blocks. 