...
One attempt at fixing this is keeping state variables that can be checked continuously. This is like locking. 
This breaks when the child doesn't acquire the lock. Notifying a thread that it's done without taking a lock is called a **