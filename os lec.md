...
A device has registers: status, command, and data. This means that the OS has two options to interact with I/O devices: either directly talking to the device in physical memory or using 