...
Multi-horizon forecasting models usually have temporal information that's very difficult to organize, such as information about the future, static metadata, and historical time series data. We want to maintain as much integrity of the da