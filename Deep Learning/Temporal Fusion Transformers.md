...
Previous time-series work doesn't consider static covariates, but the TFT architecture uses a separate encoder-decoder attention for static features at each time step