...
As of the writing of the paper, deep learning methods could be categorized into iterative autoregressions or direct sequence-to-sequence models. The iterative models typically assume that the values of all variables excluding the target are known at forecast time (which typically isn't true), and deep learning methods typically aren't explainable. TFT fixes both of these. 
