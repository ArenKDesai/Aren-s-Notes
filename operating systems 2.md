...
These directories can be thought of as a tree. For example, the root in Unix is **/**, and it includes directories such as **bin**, **usr**, etc.. We can **mount** a file system by attaching it