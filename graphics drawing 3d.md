...
**Barycentric coordinates** (see [[3D Rendering]]) are convenient for calculating texture mapping as well. Using barycentric interpolation on triangles allows for fine-tuned colors based on the color data of the three vert