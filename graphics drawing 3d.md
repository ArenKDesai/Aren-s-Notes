...
At this point in a traditional drawing algorithm, the pixels are drawn to the frame buffer at point $(x, y)$ with color $c$ and depth $z$. In the Z-Buffer algorithm,