...
At this point in a traditional drawing algorithm, the pixels are drawn to the frame buffer at point $(x, y)$ with color $c$ In the Z-Buffer algorithm, the depth $z$ is also kept 