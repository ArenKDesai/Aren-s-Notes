...
Run an instance in Y through a reduction, it outputs a sub-instance in X. The idea is to have a black box solver for X that gives us a solution for the sub-instance, and that implies a solution for the instnace