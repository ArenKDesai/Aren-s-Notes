...
Proof: If $S$ is an independent set, then for any edge, at most one of the two endpoints belong to $S$ (def of independent set), so everything else left over have to contain at least on 