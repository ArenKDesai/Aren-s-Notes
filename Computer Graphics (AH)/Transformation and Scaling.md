...
Translations and rotations both are **rigid transformations**, where distances and handedness are preserved. **Handedness** is the direction of rotation, so having different handedness means that a reflection of mirror (or something else) ocurred, and the rotation from one thing onto 