...
When trying to fit a curve to a set of $n$ points there are options. The easiest would be to make linear line segments with a first-degree polynomial, and second easiest would be to make an $n-1$ degree polynomial. 