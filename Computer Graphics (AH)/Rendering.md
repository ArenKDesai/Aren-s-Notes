...
Typically, we consider pixels as a grid on our computer screen (for this one, 1920x1080). The region inside the squares made by pixels don't typically exist, so the grid is thought of a 