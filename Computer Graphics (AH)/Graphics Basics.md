...
We draw elements either from fixed positions with light or variable positions with primitives drawn from them. This is sampled (raster) vs geometric (primitives). Most of what we work with is sampled due to the pix