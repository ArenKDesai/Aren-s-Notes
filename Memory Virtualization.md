...
### Paging
A form of segmentation. We have fixed, same-size segments. In a 32-bit address, the top 20 bits is a page number, while the last 12 are the page offset. We translate 