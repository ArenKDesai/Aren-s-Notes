...
![[aucroc_curve.png]]
However, AUC ROC being classification threshold-invariant can be a downside if you want to factor in the classification threshold, in which case the Area Under the Precision-Recall (AUC PR) Curve is plotted. 
