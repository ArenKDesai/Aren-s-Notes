...
1. Collect. GCP services include:
	...
	3. BigQuery Data Transfer Service, which transfers data from warehouses like Teradata and Amazon Redshift, external cloud providers such as Amazon S3, and 