...
Document AI has two important concepts: processors and Document AI Warehouse. A processor is an interface between the document and a machine learning models. There are a few different types of processors, including procurement, lending, contract, custom, etc. A warehouse can hold documents, and use AI to organize, govern, and analyze them. 
