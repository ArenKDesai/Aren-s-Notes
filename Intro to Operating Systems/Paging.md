...
Imagine we have 16 byte pages in a 64 byte address space. We'd have $\frac{64}{16}=4$ pages, of which we could cover the VPNs for with $4=2^x$, $\log(4)=x\log(2)$, $x=2$ 
