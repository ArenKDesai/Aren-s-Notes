...
A TLB typically has 32, 64, or 128 entries, and be a **fully-associative** TLB. This means that any given translation could be anywhere in the TLB - no restrictions or special cases. A TLB entry of this nature will typically consist of a VPN, a PFN (the contents of a page), and some unused bits. 
