...
However, the hardware must first find the page table for the currently running process. Sometimes, the physical address of the starting location is stored in a 
