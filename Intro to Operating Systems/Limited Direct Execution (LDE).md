...
This is how we save context during process-to-OS changes. This stores PID, process state, execution state, scheduling priority, accounting information, credentials, and pointers to other a
