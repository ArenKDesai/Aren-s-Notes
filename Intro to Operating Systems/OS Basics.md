...
Operating systems take care of virtualization, concurrency, and persistence. They promote the usage of hardware resources through OS policies. These polices are aimed at rescheduling processes for fairness and efficiency. Earliest deadline first (the [[Greedy]])
