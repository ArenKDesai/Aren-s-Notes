...
### Process Creation
To create a program, an OS must first load its code and any static data into memory / the address space of the process. Processes are typically stored as bytes on an HD or SSD. 