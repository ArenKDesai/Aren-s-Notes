...
The easiest fix for external fragmentation is to re-arrange memory allocation. However, this process is endlessly expensive, and not practical. A number of potential solutions have been invented, such as 