...
When looking for a page, the hardware checks the TLB first. If there's a hit, the page is in physical memory. If there's a miss, the present bit is checked. If the present bit is not set, 
