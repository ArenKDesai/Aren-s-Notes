...
During address translation, instead of adding the base value to the virtual address, the hardware adds the base value to the offset of the segment. The first two bits of the virtual address is typically used to find
