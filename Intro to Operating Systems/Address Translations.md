...
The bounds register is used to keep virtual address translations within reasonable bounds. This is helpful to avoid querying the hardware for the memory in an address that doesn't exist, which could cau