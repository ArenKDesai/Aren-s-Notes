...
An important notion when faking lighting (and reflections) is **sky boxes**. This is using a texture (usually the sky but it doesn't have to be) to place a giant cube around the user