...
This notion can be used to place boxes around reflecting objects to fake reflection. This is called **environment mapping**. This allows us to paint the outside world on the inside of the box, so the reflection can see objects that the user can't