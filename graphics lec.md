...
In 2D, a tangent is the slope of a curve on a point, and the tangent isThis means the tangent to a curve is a vector, and the normal to a curve is a plane. This