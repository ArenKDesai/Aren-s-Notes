...
### Greedy Approach
Initialize $f(e)=0$ for all edges, find augmenting edges, and update flow with the bottleneck along $P$ (augmenting path). We use Bellman Ford (although it's slower than Dijkstra's). 