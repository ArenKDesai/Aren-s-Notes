...
Generally, for NP problems, you need to show there exists an efficient certifier for those problems. This can be done by just proving that an algorithm can be solved in poly
