...
Matrices can perform a 3D rotation, but aren't human readable or super useful. Euler angles provide 3 arbitrary axes to rotate around (XYZ, XZX, etc). Axis angles add 