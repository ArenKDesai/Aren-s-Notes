...
Rotations in 2D are simple. While they can be represented as a linear transformation, you can represent any rotation as a difference on the unit circle, also known as an angle. Since we work in the dimension ab