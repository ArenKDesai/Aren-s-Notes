...
Each of these methods have strengths and weaknesses --- Axis and Euler angles cannot be applied to a point, matrices cannot be linearly interpolated, etc --- but 