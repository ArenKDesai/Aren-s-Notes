...
So, we have an array of disks. How do we map blocks in the linear array to disks in the RAID? We'll denote the number of disks as $N$ and the capacity in gigabytes as There are a few options:
