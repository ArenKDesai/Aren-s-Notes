...
For the Operating System, the disk is abstracting to a linear array. This means that multiple disks can be set up to extend the linear array without any difficult 