...
### Poll
The consumer's poll function returns batches when there's either enough data or there's a timeout. The batches contain some subset of partitions, and there's some numbre of messages in a partition, starting at the offset. 