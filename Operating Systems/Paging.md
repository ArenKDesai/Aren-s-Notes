...
In this format, under a TLB miss, we have three new equations. The first is to calculate the **segment number**, which we find from the virtual address, the segment mask, and the shif
