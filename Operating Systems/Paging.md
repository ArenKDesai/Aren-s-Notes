...
We track all pages with a **page directory**. The base register points to the page directory, and the page directory is a page that points to all other pages. 
