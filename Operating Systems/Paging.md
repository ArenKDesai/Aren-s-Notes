...
### Larger Pages
Having larger pages would allow us to store more memory the process requires without the need for overhead. However, these large pages can easily lead to **internal fragmentation** if we have a loto
