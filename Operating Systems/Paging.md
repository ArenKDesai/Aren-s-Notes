...
We make a page table per logical segment of the process's memory. The base and bounds registers stay on the MMU, but the base register now points towards 
