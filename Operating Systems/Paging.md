...
We track all pages with a **page directory**. The base register points to the page directory, and the page directory contains **page directory entries** . The valid bit changes meanings 
