...
## Thrashing
If you run out of memory, you end up trashing pages directly after bringing them into memory. This is called thrashing, where most of your time is spent in page faults. 