...
## Mapping
The kernel can use mapping to organize file permissions, such as allowing execute permissions through an offset. This also works for sharing if the kernel maps two processes 