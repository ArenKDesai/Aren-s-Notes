...
**Diatoms**, or **golden algae** are unicellular phytoplankton in freshwater and marine environments. They produce oxygen and use lipid droplets to float. They have symmetrical disks of two interlocking "tests", which consist of silica cell walls with pores. The silica tests accumulate on the bottom as diatomaceous earth. 
