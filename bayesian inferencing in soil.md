...
We want to capture temporal data in local source profiles. We can find site-specific coefficients, defined positively so the local and global source profiles have the same sign, and multiply them bu